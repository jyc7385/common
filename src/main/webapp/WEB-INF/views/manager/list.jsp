...
<div class="container">
	<div class="panel-body" style="padding-top: 0px;">
		<button id="userBtn" type="button" class="btn btn-primary pull-right" onclick="location.href='/manager/info'">계정</button>
	</div>
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<div class="btn-group pull-right" style="margin-top:-8px;">
						<button type="button" class="btn btn-info" onclick="location.href='/manager/register'">시설 등록</button>
					</div>
					...
					<table class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<th style="text-align:center;">예약 관리</th>
							</tr>
						</thead>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".move_place").on("click",function(e) {
			...
			actionForm.attr("action", "/manager/get");
			actionForm.submit();
		});
